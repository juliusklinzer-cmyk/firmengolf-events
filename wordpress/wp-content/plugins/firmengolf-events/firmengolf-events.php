...
require_once FGE_DIR . 'includes/mail-config.php';
require_once FGE_DIR . 'includes/catalogs.php';
require_once FGE_DIR . 'includes/partner-media.php';
require_once FGE_DIR . 'includes/image-credit.php';
...
require_once FGE_DIR . 'includes/extra-services.php';
...
require_once FGE_DIR . 'includes/email-verification.php';
require_once FGE_DIR . 'includes/offers.php';
...
require_once FGE_DIR . 'includes/privacy-hardening.php';
require_once FGE_DIR . 'includes/partnercodes.php';
...
require_once FGE_DIR . 'includes/partner-invite.php';
require_once FGE_DIR . 'includes/partner-embed.php';
