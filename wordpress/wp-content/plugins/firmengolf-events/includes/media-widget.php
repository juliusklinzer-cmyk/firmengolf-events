...
function fge_media_widget_config( int $partner_id ): array {
	...
	return [
		...
		'i18n'      => [
			...
			// Beim Golflehrer ist der „Logo"-Slot das Profilbild der Person
			// (Lehrer haben selten ein Logo, Julius 02.09.). course/indoor: Logo.
			'slotLogoLabel'  => 'coach' === $ptype ? 'Profilbild' : 'Logo',
			'slotCoverLabel' => 'Titelbild',
			'slotLogoEmpty'  => 'coach' === $ptype ? 'Profilbild ablegen oder klicken' : 'Logo ablegen oder klicken',
			'slotCoverEmpty' => 'Titelbild ablegen oder klicken',
			'slotCoverHint'  => 'coach' === $ptype ? 'Golfschule oder Golfplatz, wo du unterrichtest. Querformat, ideal mindestens 1600 px breit.' : 'Euer wichtigstes Bild. Ideal mindestens 1600 px breit, Querformat.',
			'slotSwap'       => 'Tauschen',
			'galleryTitle'   => 'coach' === $ptype ? 'Weitere Fotos (Kurse, Einrichtung)' : 'Weitere Fotos',
			'dropHint'       => 'Fotos hierher ziehen oder klicken',
			'checkLogo'      => 'coach' === $ptype ? 'Profilbild' : 'Logo',
			...
			'logoLabel'    => 'coach' === $ptype ? 'Profilbild' : 'Logo',
			'logoHint'     => 'coach' === $ptype ? 'Ein gutes Porträt von dir, quadratisch, ideal ca. 400×400 px. Erscheint auf deiner Visitenkarte.' : 'PNG mit transparentem Hintergrund, ideal ca. 400×400 px. Erscheint in der Trefferliste.',
			'logoChoose'   => 'coach' === $ptype ? 'Profilbild wählen' : 'Logo wählen',
			'logoReplace'  => 'coach' === $ptype ? 'Profilbild tauschen' : 'Logo tauschen',
