...
function fge_media_widget_config( int $partner_id ): array {
	...
	return [
		...
		'i18n'      => [
			...
			'reorderHint'  => 'Ziehe per Drag & Drop, um die Reihenfolge zu ändern. Das erste Foto ist dein Titelfoto.',
			...
			'coverMinWarn' => 'Hinweis: Titelfoto ist nur %d px breit — empfohlen sind mind. %d px.',
