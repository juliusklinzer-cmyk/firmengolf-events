...
function fge_get_event_format_pages(): array {
	...
	return [
		...
		'platzreife' => [
			...
			'reasons' => [ $reason( 'trophy', 'Offizieller Abschluss', 'Am Ende stehen Platzreife-Turnier und Theorieprüfung: die anerkannte Eintrittskarte für Golfplätze in ganz Deutschland.' ), $reason( 'clock', 'Kompakt in 4 Tagen', 'Rund 12 Trainerstunden, am Stück oder verteilt über mehrere Termine, passend zum Arbeitskalender.' ), $reason( 'gift', 'Benefit mit Substanz', 'Ein Programm, das bleibt: kein einmaliges Event, sondern der Start in einen Sport fürs Leben.' ), $r_one ],
		...
		'workshop' => [
			...
			'reasons' => [ $reason( 'leaf', 'Frischer Kopf', 'Vormittags Workshop, mittags Clubterrasse, nachmittags Bewegung an der frischen Luft. So hält die Konzentration den ganzen Tag.' ), $reason( 'sun', 'Ausklang am Grün', 'Zum Abschluss ein Golf-Grundlagenkurs mit Golflehrer, ein gemeinsames Erlebnis statt letzter Folien.' ), $r_team, $r_one ],
		...
		'incentive' => [
			...
			'reasons' => [ $reason( 'mountain', 'Besondere Kulissen', 'Anlagen mit Berg- und Seeblick, die ein Incentive zum echten Erlebnis machen.' ), $reason( 'castle', 'Mehrtägig mit Hotel', 'Golf, Übernachtung, Dinner und Rahmenprogramm an einem Ort, ideal als Belohnung fürs Team.' ), $r_team, $r_one ],
