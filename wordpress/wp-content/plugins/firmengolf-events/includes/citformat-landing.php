...
function fge_citformat_format_meta(): array {
	return [
		...
		'workshop' => [
			...
			'desc'  => 'Workshop-Location in %s: Konferenzraum im Clubhaus, Mittagsbuffet auf der Clubterrasse, Golf-Grundlagenkurs zum Ausklang. Ab 190 € pro Person.',
		],
		'kundenevent' => [
