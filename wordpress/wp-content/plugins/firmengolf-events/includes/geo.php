...
function fge_geo_city_coords( string $place ): ?array {
	static $map = [
		...
		'erlangen'               => [ 49.590, 11.012 ],
		'essen'                  => [ 51.456, 7.012 ],
		'garmisch-partenkirchen' => [ 47.492, 11.095 ],
		'garmisch'               => [ 47.492, 11.095 ],
		'ingolstadt'             => [ 48.767, 11.426 ],
		'itzehoe'                => [ 53.925, 9.516 ],
		'karlsruhe'              => [ 49.007, 8.404 ],
		'kiel'                   => [ 54.323, 10.123 ],
		'landshut'               => [ 48.537, 12.151 ],
		'leipzig'                => [ 51.340, 12.373 ],
		'lübeck'                 => [ 53.865, 10.687 ],
		'luebeck'                => [ 53.865, 10.687 ],
		'lüneburg'               => [ 53.246, 10.412 ],
		'lueneburg'              => [ 53.246, 10.412 ],
		'mannheim'               => [ 49.487, 8.466 ],
		'penzberg'               => [ 47.752, 11.377 ],
		'regensburg'             => [ 49.013, 12.102 ],
		'rosenheim'              => [ 47.856, 12.129 ],
		'ulm'                    => [ 48.401, 9.988 ],
		'würzburg'               => [ 49.791, 9.953 ],
		'wuerzburg'              => [ 49.791, 9.953 ],
	];
