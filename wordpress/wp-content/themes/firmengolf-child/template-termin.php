...
<body class="tl-page">
	...
	<?php else :
		...
		<div class="tl-done">
			...
			<?php else : ?>
			<h2><?php echo $first ? 'Danke, ' . esc_html( $first ) . ', gespeichert.' : 'Danke, gespeichert.'; ?></h2>
		...
		<h1 class="tl-h"><?php echo $first ? 'Hallo ' . esc_html( $first ) . ', passt' : 'Hallo, passt'; ?> <em>einer dieser Termine</em>?</h1>
